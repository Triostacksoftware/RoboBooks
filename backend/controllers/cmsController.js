...
const CMS_DEFAULTS = {
  ...
  footer: {
    ...
    legalTitle: "Legal",
    productLinks: [
      { label: "About RoboBooks", href: "/about-robobooks" },
      { label: "Book a demo", href: "/book-a-demo" },
      { label: "Start free trial", href: "/start-free-trial" },
      { label: "GSTR Filing", href: "/gstr-filing" },
      { label: "E-Invoicing", href: "/e-invoicing" },
      { label: "Delivery Challan", href: "/delivery-challan" },
      { label: "Data Export to Sale", href: "/data-export-to-sale" },
      { label: "Bank Reconciliation", href: "/bank-reconciliation" },
      { label: "Import Export of Data", href: "/import-export-of-data" },
      { label: "Multiple Financial Reporting", href: "/multiple-financial-reporting" },
    ],
    companyLinks: [
